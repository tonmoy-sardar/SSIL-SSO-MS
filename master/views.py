...
class CloneModuleRole(APIView):
    ...
    def clone_role_add(self, role_data: dict, module_id: int):
        ...
        try:
            ...
            raise e
class TMasterModuleGroupCreateView(generics.ListCreateAPIView):
    permission_classes = [IsAuthenticated]
    authentication_classes = [TokenAuthentication]
    queryset = TMasterModuleGroup.objects.all()
    serializer_class = TMasterModuleGroupSerializer
class TMasterModuleGroupEditView(generics.RetrieveUpdateAPIView):
	permission_classes = [IsAuthenticated]
	authentication_classes = [TokenAuthentication]
	queryset = TMasterModuleGroup.objects.all()
	serializer_class = TMasterModuleGroupEditSerializer
class TMasterModuleGroupDeleteView(generics.RetrieveUpdateAPIView):
	permission_classes = [IsAuthenticated]
	authentication_classes = [TokenAuthentication]
	queryset = TMasterModuleGroup.objects.all()
	serializer_class = TMasterModuleGroupDeleteSerializer
